...
export default function About() {
  ...
  const fetchStats = async () => {
    try {
      const [p, c] = await Promise.all([projectApi.list(), certificateApi.list()])
    ...
    >
      <div style={{ width: '100%' }}>
        ...
        >
          ...
          >
            <motion.div variants={fadeUp} style={{ marginBottom: isMobile ? 12 : 16 }}>
              <span
                style={{
            ...
            <motion.div variants={fadeUp}>
              <div
                style={{
                  fontSize: isMobile ? 'clamp(30px, 10vw, 40px)' : 'clamp(32px,5vw,46px)',
                  fontWeight: 800,
                  lineHeight: 1.03,
            ...
            >
              ...
              (MongoDB, Express, React, Node.js) with JavaScript and
              TypeScript. I love building clean, responsive UIs with React
              and Tailwind, designing robust REST APIs with Express, and
              modelling data in MongoDB. Always shipping, always learning —
              currently exploring Next.js, Docker, and cloud deployment.
            </motion.p>
            ...
            >
              "Turning ideas into fast, scalable, and meaningful web experiences."
            </motion.div>
        ...
        >
          {stats.map((item, i) => (
            ...
            >
              ...
              <div style={{ fontSize: isMobile ? 9 : 11, letterSpacing: '0.08em' }}>{item.title}</div>
